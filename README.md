...
- **Цели** → `docs/goals.md`
- **Проекты, задачи, минизадачи** → `docs/projects/`
- **Повестка на следующую сессию** → `docs/next-session-agenda.md`
- **Входящие идеи (инбокс)** → `docs/backlog.md`
...
Как ведётся работа (Цели → Проекты → Задачи → Минизадачи) — в `docs/process.md`.
